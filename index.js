...
function Toolbar(){
  ...
  <img
    width={40}
    alt="Angular Logo"
    src=" https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTk_4Oqo86vUSt-u29ZML1rw_F1-IGcp6IOcw&amp;usqp=CAU "
  />
  <span>C.S.D</span>
...
/*home*/
 function Home(){
  ...
  <div className="card-container">
    <a className="card" target="_blank" rel="noopener" href="https://angular.io/tutorial">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Bitcoin.svg/1200px-Bitcoin.svg.png " height="50" width="50" page-data-link="bitcoin"/>
      ...
      <div className="card-container">
    <a className="card" target="_blank" rel="noopener" href="https://angular.io/tutorial">
    <img src=" https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSr1oYAneqROrS4rbHNTaqcbARLcUn64Tjkg&amp;usqp=CAU " height="70" width="80"/>
      
      <span>Ethereum</span>
      <svg className="material-icons" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>    </a></div>
      
      <section className="clients">
  <h3 className="h3 clients-title">Mining coin</h3>
  <p className="p cliants-text">
    Earning section for mining crypto and earn for posting and watching.
  </p>
...
<div className="item">
  ...
  <p className="item-price">
    The CSD network is the new coin maintening by career skills development team.
  </p>
  <button className="add-to-cart-btn">Start Mining</button>
</div>
<hr/>
       ...
       <div className="chat-notification-logo-wrapper">
         <a href="/">
           <img className="chat-notification-logo"
            src=" https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBdtYyvMMpokM7q_IwYbQUmd6WbvBUEo6PMA&amp;usqp=CAU " 
            alt="chat-logo" /></a>
           </div>
           <div className="chat-notification-content">
             <h4 className="chat-notification-title">Alibaba</h4>
             <p className="chat-notification-message">By anything from Alibaba store</p>
             </div></div>
             <br/>
  <div className="chat-notification">
    <div className="chat-notification-logo-wrapper">
